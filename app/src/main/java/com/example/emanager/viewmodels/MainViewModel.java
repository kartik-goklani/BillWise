...
public class MainViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<ArrayList<GroupExpense>> groupExpensesLiveData = new MutableLiveData<>(new ArrayList<>());
    private ArrayList<GroupExpense> groupExpensesList = new ArrayList<>();
    ...
    public void addGroupExpense(GroupExpense groupExpense) {
        ...
        groupExpensesLiveData.setValue(groupExpensesList);
    }

    public MutableLiveData<ArrayList<GroupExpense>> getGroupExpenses() {
