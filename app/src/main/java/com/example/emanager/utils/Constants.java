...
public class Constants {
    ...
    public static final String PREFERENCE_NAME = "user_prefs"; // Name of SharedPreferences
    public static final String KEY_USER_NAME = "user_name"; // Key for storing user name
